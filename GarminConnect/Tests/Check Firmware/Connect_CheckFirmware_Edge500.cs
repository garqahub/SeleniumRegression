...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_Edge500 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_Edge500(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_Edge500";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an Edge 500 and check for the firmware update notice**";
        ...
        public override void RunTest()
        {
            ...
            utility.UploadFile(@"C:\RegressionUpload\Edge500_Timing_Ele_Temp.fit");
