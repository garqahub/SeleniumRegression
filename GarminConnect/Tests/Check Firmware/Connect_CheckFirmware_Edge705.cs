...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_Edge705 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_Edge705(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_Edge705";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an Edge 705 and check for the firmware update notice**";
        ...
        public override void RunTest()
        {
            ...
            utility.UploadFile(@"C:\RegressionUpload\Edge705_v2_1.tcx");
