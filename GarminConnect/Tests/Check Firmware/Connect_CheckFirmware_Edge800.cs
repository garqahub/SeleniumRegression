...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_Edge800 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_Edge800(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_Edge800";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an Edge 800 and check for the firmware update notice**";
        ...
        public override void RunTest()
        {
            ...
            utility.UploadFile(@"C:\RegressionUpload\Edge8002010-07-10-13-04-55.fit");
