...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_FR110 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_FR110(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_FR110";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an FR 110 and check for the firmware update notice**";
        ...
        public override void RunTest()
        {
            ...
            utility.UploadFile(@"C:\RegressionUpload\Forerunner 110.fit");
