...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_FR201 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_FR201(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_FR201";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an FR 201 and check for the firmware update notice**";
