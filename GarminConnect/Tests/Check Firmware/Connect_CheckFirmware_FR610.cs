...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_FR610 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_FR610(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_FR610";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an FR 610 and check for the firmware update notice**";
        ...
        public override void RunTest()
        {
            ...
            utility.UploadFile(@"C:\RegressionUpload\20110612-FR610-TrainingEffect.FIT");
