...
namespace SeleniumRegression
{
    ...
    class Connect_CheckFirmware_FR910 : ParentTest
    {
        ConnectUtility utility;
        public Connect_CheckFirmware_FR910(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckFirmware_FR910";  //Enter Test Name
            ...
            base.description = "**Create a user, upload a file from an FR 910 and check for the firmware update notice**";
        ...
        public override void RunTest()
        {
            ...
            utility.UploadFile(@"C:\RegressionUpload\910XT_20120227-173721-1-1328-ANTFS-4-0.FIT");
