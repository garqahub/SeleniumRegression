...
namespace SeleniumRegression
{
    ...
    class Kenwood_CheckEach_NA_DeviceType_fortheProductUpdates : ParentTest
    {
        KenwoodFunctions ken;

        public Kenwood_CheckEach_NA_DeviceType_fortheProductUpdates(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "CheckEach_NA_DeviceType_fortheProductUpdates";  //Enter Test Name
            ...
            base.description = "**CheckEach_NA_DeviceType_fortheProductUpdates**";
        ...
        public override void RunTest()
        {
            ...
            string availableNAdevices = quality.GetText("css=div.itemSelectionBox");
            char[] splits = { '\n', ' ' };
            string[] NAdevices = availableNAdevices.Trim().Split(splits);

            List<string> l = new List<string>();

            int i = 0;

            foreach (string s in NAdevices)
            {
                if ((s != " ") && (s != ""))
                {
                    l.Add(s);
