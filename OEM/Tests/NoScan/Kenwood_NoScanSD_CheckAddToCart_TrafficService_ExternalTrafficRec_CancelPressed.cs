...
namespace SeleniumRegression
{
    ...
    class Kenwood_NoScanSD_CheckAddToCart_TrafficService_ExternalTrafficRec_CancelPressed : ParentTest
    {
        KenwoodFunctions ken;

        public Kenwood_NoScanSD_CheckAddToCart_TrafficService_ExternalTrafficRec_CancelPressed(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "NoScanSD_CheckAddToCart_TrafficService_ExternalTrafficRec_CancelPressed";  //Enter Test Name
            ...
            base.description = "**NoScanSD_CheckAddToCart_TrafficService_ExternalTrafficRec_CancelPressed**";
