...
namespace SeleniumRegression
{
    ...
    class Kenwood_NoScanSD_CheckShoppingCart_ForATrafficServcie_TryToUpdate : ParentTest
    {
        KenwoodFunctions ken;

        public Kenwood_NoScanSD_CheckShoppingCart_ForATrafficServcie_TryToUpdate(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "NoScanSD_CheckShoppingCart_ForATrafficServcie_TryToUpdate";  //Enter Test Name
            ...
            base.description = "**NoScanSD_CheckShoppingCart_ForATrafficServcie_TryToUpdate**";
