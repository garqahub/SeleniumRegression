...
namespace SeleniumRegression
{
    ...
    class Kenwood_ScanSD_CheckLatestMap_DeviceRequieresUpdates_DNX7180_Validation : ParentTest
    {
        KenwoodFunctions ken;

        public Kenwood_ScanSD_CheckLatestMap_DeviceRequieresUpdates_DNX7180_Validation(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "ScanSD_CheckLatestMap_DeviceRequieresUpdates_DNX7180_Validation";  //Enter Test Name
            ...
            base.description = "**ScanSD_CheckLatestMap_DeviceRequieresUpdates_DNX7180_Validation**";
        ...
        public override void RunTest()
        {
            ...
            Update_XML.XMLEdit("SoftwareVersion", "429");
            ...
            if (ken.CheckForTimeOut("Device Information Found", "css=div.titleHeader-text", 61))
            {
                failedcheck++;
            }
            ...
            quality.AreEqual("Kenwood Receiver Software for DNX7180", quality.GetText("css=p.header"));
            ...
            //updateXML.WriteXML("DNX7180_XML");
