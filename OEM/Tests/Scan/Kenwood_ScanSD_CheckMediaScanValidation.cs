...
namespace SeleniumRegression
{
    ...
    class Kenwood_ScanSD_CheckMediaScanValidation : ParentTest
    {

        KenwoodFunctions ken;
        public Kenwood_ScanSD_CheckMediaScanValidation(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "ScanSD_CheckMediaScanValidation";  //Enter Test Name
            ...
            base.description = "**ScanSD card Check Media Scan Validation**";
        ...
        public override void RunTest()
        {
            ...
            for (int second = 0; second < 61; second++)
            {
                if (second >= 60)
                {
                    quality.ErrorReport("Scan Timeout", CheckType.Warning);
                } 
                try
                {
