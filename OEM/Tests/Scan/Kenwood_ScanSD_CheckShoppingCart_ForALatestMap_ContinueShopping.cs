...
namespace SeleniumRegression
{
    ...
    class Kenwood_ScanSD_CheckShoppingCart_ForALatestMap_ContinueShopping : ParentTest
    {
        KenwoodFunctions ken;
        public Kenwood_ScanSD_CheckShoppingCart_ForALatestMap_ContinueShopping(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "ScanSD_CheckShoppingCart_ForALatestMap_ContinueShopping";  //Enter Test Name
            ...
            base.description = "**ScanSD_CheckShoppingCart_ForALatestMap_ContinueShopping**";
