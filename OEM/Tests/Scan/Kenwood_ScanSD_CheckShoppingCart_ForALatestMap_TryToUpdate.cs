...
namespace SeleniumRegression
{
    ...
    class Kenwood_ScanSD_CheckShoppingCart_ForALatestMap_TryToUpdate : ParentTest
    {
        KenwoodFunctions ken;

        public Kenwood_ScanSD_CheckShoppingCart_ForALatestMap_TryToUpdate(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "ScanSD_CheckShoppingCart_ForALatestMap_TryToUpdate";  //Enter Test Name
            ...
            base.description = "**ScanSD_CheckShoppingCart_ForALatestMap_TryToUpdate**";
