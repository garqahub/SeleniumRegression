...
namespace SeleniumRegression
{
    ...
    class Kenwood_ScanSD_CheckTheSoftwareUpdates_FirmwareValidation : ParentTest
    {
        KenwoodFunctions ken;
        public Kenwood_ScanSD_CheckTheSoftwareUpdates_FirmwareValidation(string url, WebDriverBackedSelenium webdriver, StringBuilder verrors)
        {
            //****Enter in Script Name here****  
            base.id = "ScanSD_CheckTheSoftwareUpdates_FirmwareValidation";  //Enter Test Name
            ...
            base.description = "**ScanSD and Check for Software updates/Firmware Validation**";
